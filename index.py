...
def menu_patient(conn):
	...
	while (choix < 5) :
		...
		choix=int(input("Que voulez-vous faire ? Tapez un nombre entre 1 et 5 et tapez 6 pour revenir en arriere : "))
...
def menu_personnel(conn):
	...
	while (choix < 4) :
		...
		"\t 3 - Afficher tout le personnel soignant \n",
		"\t 4 - Revenir au menu principal \n")
		choix=int(input("Tapez un nombre entre 1 et 5 ou tapez 6 pour revenir en arriere : "))
...
def main ():
	...
	try:
		server = input("Entrez le nom du serveur sur lequel se trouve la base de données :")
		dbname = input("Entrez le nom de votre base de données :")
